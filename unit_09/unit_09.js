...
function f5() {
    ...
    let hasBgOrange = out4.classList.contains('bg-orange');
    document.querySelector('.out-5').textContent = hasBgOrange;
}
...
function f18() {
    ...
    const attributeValue = p18.getAttribute('data-b');
    const out18 = document.querySelector('.out-18');
    out18.textContent = attributeValue;
}
...
function f19() {
    const p19Elements = document.querySelectorAll('.p-19');
    let attributeValues = '';
    p19Elements.forEach(function (element) {
    attributeValues += element.getAttribute('data-b') + ' ';
    });
    const out19 = document.querySelector('.out-19');
    out19.textContent = attributeValues.trim();
