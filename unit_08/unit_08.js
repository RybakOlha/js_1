...
function t6() {
    ...
    let number = parseInt(document.querySelector('.i-6').value);
    let t = 1;
    while (t <= number){
        out.innerHTML += '******' + '<br>';
        t++;
...
function t7() {
    ...
    let number = parseInt(document.querySelector('.i-7').value);
    let i = '';
    while (number >= 0){
        i += number + '_';
        number--;
...
function t8() {
    ...
    let number1 = parseInt(document.querySelector('.i-81').value);
    let number2 = parseInt(document.querySelector('.i-82').value);
    while (number2 >= number1){
        out.innerHTML += number1 + '_';
        number1++;
    }
}
...
function t9() {
    ...
    let number1 = parseInt(document.querySelector('.i-91').value);
    let number2 = parseInt(document.querySelector('.i-92').value);
    let t = '';
    if (number1 > number2){
        let temp = number1;
        number1 = number2;
