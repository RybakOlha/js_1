...
//Navigator
/*
За допомогою елемента navigator,
можемо отримати інформацію про
...
//За допомогою обʼєкту location  можемо
//отримати поточний URL або
//перенаправити браузер за новою адресою.
...
//History
/*
Обʼєкт history дозволяє
керувати історією браузера,
пересуватись відвіданими сторінками.
*/
...
//Сonfirm
const confirmResult = confirm("Маєш бажання стати веб-розробником?");
...
/*
Елементи, що знаходяться на верхівці дерева
доступні як властивості обʼєкту document
*/
/*
