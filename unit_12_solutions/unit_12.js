...
// Task 7
// Під час натискання b-7 виконуйте функцію f7. Функція повинна вивести в out-7 парні значення масиву a7. Як бачите, вкладені масиви мають різну довжину, отже, попередній варіант не працює. Використовуємо цикл. Висновок - через пропуск. функцію f5. Функція повинна вивести на out-5 парні значення з масиву a5. Під час натискання b-7 виконуєте функцію f7. Функція повинна вивести в out-7 парні значення масиву a7. Як бачите, вкладені масиви мають різну довжину, отже, попередній варіант не працює. Використовуємо цикл. Висновок - через пропуск. перебору використовуємо цикл.
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = result.trim();
}
...
function f13() {
    ...
    // Вивести масив у консоль для перевірки
    console.log(a13);
}
...
// Відповідь у цій задачі прописаний відразу. Тобто ви руками просто пишіть масив такий, щоб умови виконувалися.
